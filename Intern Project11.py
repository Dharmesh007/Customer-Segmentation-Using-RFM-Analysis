...
Rtl_data = pd.read_csv(r"C:\AA MBA (BA) Notes\A FINAL INTERNSHIP\Customer Segmentation using RFM\data.csv",  encoding = "unicode_escape")
Rtl_data.head()
...
#Set Latest date 2018-12-10 as last invoice date was 2011-12-09. This is to calculate the number of days from recent purchase
Latest_Date = dt.datetime(2018,12,10)
